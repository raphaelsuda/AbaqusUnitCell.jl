...
function LoadCase3D(strain::Matrix{<:Number}, abq::AbqModel; free=true, new=true, name="lc")
	...
	if free
        Δu_1[1]!=0 ? push!(boundaries, BoundCon("BC-04", new, "SWT", abq.csys[1], Δu_1[1])) : push!(boundaries, BoundCon("BC-04", true, "", abq.csys[1]))
        Δu_1[2]!=0 ? push!(boundaries, BoundCon("BC-05", new, "SWT", abq.csys[2], Δu_1[2])) : push!(boundaries, BoundCon("BC-05", true, "", abq.csys[1]))
        Δu_1[3]!=0 ? push!(boundaries, BoundCon("BC-06", new, "SWT", abq.csys[3], Δu_1[3])) : push!(boundaries, BoundCon("BC-06", true, "", abq.csys[1]))
        Δu_2[1]!=0 ? push!(boundaries, BoundCon("BC-07", new, "NWB", abq.csys[1], Δu_2[1])) : push!(boundaries, BoundCon("BC-07", true, "", abq.csys[1]))
        Δu_2[2]!=0 ? push!(boundaries, BoundCon("BC-08", new, "NWB", abq.csys[2], Δu_2[2])) : push!(boundaries, BoundCon("BC-08", true, "", abq.csys[1]))
        Δu_2[3]!=0 ? push!(boundaries, BoundCon("BC-09", new, "NWB", abq.csys[3], Δu_2[3])) : push!(boundaries, BoundCon("BC-09", true, "", abq.csys[1]))
        Δu_3[1]!=0 ? push!(boundaries, BoundCon("BC-10", new, "SEB", abq.csys[1], Δu_3[1])) : push!(boundaries, BoundCon("BC-10", true, "", abq.csys[1]))
        Δu_3[2]!=0 ? push!(boundaries, BoundCon("BC-11", new, "SEB", abq.csys[2], Δu_3[2])) : push!(boundaries, BoundCon("BC-11", true, "", abq.csys[1]))
        Δu_3[3]!=0 ? push!(boundaries, BoundCon("BC-12", new, "SEB", abq.csys[3], Δu_3[3])) : push!(boundaries, BoundCon("BC-12", true, "", abq.csys[1]))
    else
